Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/MTColorDistance"
  ...
  #
  s.source       = { :git => "http://EXAMPLE/MTColorDistance.git", :tag => "0.0.1" }
  # s.source       = { :svn => 'http://EXAMPLE/MTColorDistance/tags/1.0.0' }
  # s.source       = { :hg  => 'http://EXAMPLE/MTColorDistance', :revision => '1.0.0' }
